...
const {
  state
} = (0,_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_0__.store)('pm/palmares', {
  actions: {
    toggle: e => {
    ...
    closeModale: e => {
      console.log('RRR');
      _wordpress_interactivity__WEBPACK_IMPORTED_MODULE_0__.getElement.ref.closeModale();
    }
  },
  callbacks: {
    init: () => {
      const context = (0,_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_0__.getContext)();
      const defaultDecade = (0,_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_0__.getElement)().ref.dataset.defaultDecade;
